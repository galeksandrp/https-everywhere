...
### [Что означают разные цвета названий списков правил в меню значка в панели Firefox?](#what-do-the-different-colors-for-rulesets-in-the-firefox-toolbar-menu-mean)
